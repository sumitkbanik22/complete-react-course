...
function ProductDetails(props) {
    ...
    let increementProductCount = function() {
        // productCount++;
        // console.log(productCount);
        updateCount(++productCount);
    }

    let decreementProductCount = function() {
        // productCount--;
        // console.log(productCount);
        updateCount(--  productCount);
    }
    ...
    return (
        <div className="d-flex align-items-center justify-content-start mt-1">
            ...
            <Button eventHandler={decreementProductCount}>-</Button>
            <span>{displayFormattedProductCount()}</span>
            <Button eventHandler={increementProductCount}>+</Button>
